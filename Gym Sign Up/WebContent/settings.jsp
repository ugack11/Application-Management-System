...
<body>
	...
	<br>
	<form id="settingForm" action="updateProfile" onsubmit="return updated()">
		<div>
		...
		<div>
			<input class='input' style= "width:150px;margin-left:45%;" type="submit" value="Update" >
		</div>
		
	</form>
	<form id="application">
		<input class='input' type='submit' value='Upload Application' onclick ="form.action = 'application';">
		<input class='input' type='submit' value='Delete Application' onclick ="form.action = 'DeleteApplicationServlet';">	
	</form>
